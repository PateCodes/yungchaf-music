...
export default function MyContributionsPage() {
  ...
  // This is the fix: The page is only truly "loading" if the user is loading OR if the user is loaded but contributions are still fetching.
  ...
  if (!user && !isUserLoading) {
     // This case can happen briefly during redirect, or if something goes wrong.
     // Returning null is safe and prevents errors.
    return null;
  }
